...
public class Main15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asyncDialog3 = new ProgressDialog(   Main15Activity.this);
        android.support.v7.app.ActionBar AB=getSupportActionBar();

        AB.hide();
        verified =(Button)findViewById(R.id.verify12);
        mverified=(TextView) findViewById(R.id.verified12);
        verified1 =(Button)findViewById(R.id.verify11);
        mverified1=(TextView) findViewById(R.id.verified123);
        ...
        verified1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lon==true)
                {
                    ...
                    Intent intent = new Intent(Main15Activity.this, Main11Activity.class);
